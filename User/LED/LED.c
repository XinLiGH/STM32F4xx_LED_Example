 ...
 *                       Global variables
*****************************************************************/
static GPIO_TypeDef* LED_GPIO[LEDn]                = {LED1_GPIO, LED2_GPIO};
static uint16_t      LED_GPIO_Pin[LEDn]            = {LED1_GPIO_Pin, LED2_GPIO_Pin};
static uint32_t      LED_RCC_AHB1Periph_GPIO[LEDn] = {LED1_RCC_AHB1Periph_GPIO, LED2_RCC_AHB1Periph_GPIO};
static LEDState      ledState[LEDn]                = {LEDStateOff, LEDStateOff};
